...
export default function (overrides?: ReservoirKitOverrides): ReservoirKitTheme {
  ...
  return {
    colors: {
      ...
      headerBackground: overrides?.headerBackground || 'white',
      footerBackground: overrides?.footerBackground || '#F0F0F0',
      contentBackground: overrides?.contentBackground || 'white',
      priceBackground: overrides?.priceBackground || '#F0F0F0',
      closeBorder: overrides?.closeBorder || '#777E91',
      pColor: overrides?.pColor || '#909090',
      wellBackground: overrides?.wellBackground || '$gray3',
      boxBackground: overrides?.boxBackground || '#fff',
      switchBorder: overrides?.switchBorder || '#777E91',
